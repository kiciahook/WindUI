...
function Tag:New(TagConfig, Parent)
    ...
    if TagModule.Icon then
        ...
        TagIcon.ImageLabel.ImageColor3 = typeof(TagModule.Color) == "Color3" and GetTextColorForHSB(TagModule.Color)
            or nil
    end
    ...
    function TagModule:SetColor(color)
        ...
        if typeof(color) == "table" then
            ...
            Tween(TagTitle, 0.06, { TextColor3 = GetTextColorForHSB(avgColor) }):Play()
            ...
            Tween(TagTitle, 0.06, { TextColor3 = GetTextColorForHSB(color) }):Play()
            if TagIcon then
                Tween(TagIcon.ImageLabel, 0.06, { ImageColor3 = GetTextColorForHSB(color) }):Play()
            end
